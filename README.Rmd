...
- **Use the embeddings in downstream analyses**: for example, training models to predict psychological constructs with the [text](https://www.r-text.org/)-package.

See the [Getting started tutorial](https://www.r-talk.org/articles/talk.html) for a walk-through of the workflow, and [HuggingFace](https://huggingface.co/models/) for the available models.
